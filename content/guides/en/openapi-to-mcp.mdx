...
Add the MCP server URL to Claude (*Customize → Connectors*, [step by step](https://anythingmcp.com/claude-connectors)), ChatGPT, Cursor or VS Code. Every tool of the spec is available immediately; no restart.
